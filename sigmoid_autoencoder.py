...
plt.ylabel('Loss')
plt.plot(losses[-100:])
plt.savefig('50000_sigmoid_loss_plot.png')
...
plt.ylabel('Loss')
plt.plot(total_loss)
plt.savefig('50000_sigmoid_test_losses_plot.png')
