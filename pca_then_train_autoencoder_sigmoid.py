...
class AE(torch.nn.Module):
    def __init__(self):
        ...
        # linear encoder with linear layers and Sigmoid activation functions
        # 496 --> 8
        ...
        # build linear layer followed by Sigmoid activation functions, with the last being Sigmoid activation since the output should be binary
        # 8 --> 496
...
plt.ylabel('Loss')
plt.plot(losses[-100:])
plt.savefig('pca_50000_sigmoid_train_loss.png')
